        ...
        <div class="card-body">
            <form action="{{ route('proveedores.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="rtn_proveedor" id="rtn_proveedor" class="form-control rounded-pill @error('rtn_proveedor') is-invalid @enderror" value="{{ old('rtn_proveedor') }}" required>
                    @error('rtn_proveedor')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="direccion_proveedor" id="direccion_proveedor" class="form-control rounded-pill @error('direccion_proveedor') is-invalid @enderror" value="{{ old('direccion_proveedor') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="telefono_proveedor" id="telefono_proveedor" class="form-control rounded-pill @error('telefono_proveedor') is-invalid @enderror" value="{{ old('telefono_proveedor') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email_proveedor" id="email_proveedor" class="form-control rounded-pill @error('email_proveedor') is-invalid @enderror" value="{{ old('email_proveedor') }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const restrictedFields = [
                ...
                'contacto_proveedor',
                'telefono_proveedor',
                'direccion_proveedor'  // Agregado el campo de dirección
            ];
