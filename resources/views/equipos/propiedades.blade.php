...
<div class="container-fluid mt-4"> <!-- Usa container-fluid para ocupar todo el ancho -->
    <div class="card"> <!-- Tarjeta sin límite fijo de ancho -->
        <div class="card-body">
            ...
            <table id="table" class="table table-striped table-bordered table-hover rounded shadow-sm text-center">
            ...
            <table id="table" class="table table-striped table-hover rounded shadow-sm text-center">
                <thead class="thead-dark">
                    <tr>
