                    ...
                    <tbody class="text-center">
                        ...
                        @foreach($objetos as $objeto)
                            <tr>
                                <td>{{ ++$i }}</td>
                                <td>{{ $objeto->objeto }}</td>
                                <td><input type="checkbox" name="permisos[]" value="VER_{{ $objeto->objeto }}"></td>
                                <td><input type="checkbox" name="permisos[]" value="INSERTAR_{{ $objeto->objeto }}"></td>
                                <td><input type="checkbox" name="permisos[]" value="EDITAR_{{ $objeto->objeto }}"></td>
                                <td><input type="checkbox" name="permisos[]" value="ELIMINAR_{{ $objeto->objeto }}"></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
