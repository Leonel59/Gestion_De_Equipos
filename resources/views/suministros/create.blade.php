...
@section('title', 'Agregar Suministro')

@section('content_header')
<h1>Agregar Suministro</h1>
@stop
...
<div class="card">
    ...
    <input type="text" name="nombre_suministro" id="nombre_suministro" class="form-control @error('nombre_suministro') is-invalid @enderror" value="{{ old('nombre_suministro') }}" placeholder="ej. Mouse, Teclados" required>
...
<div class="form-group">
    ...
    <textarea name="descripcion_suministro" id="descripcion_suministro" class="form-control @error('descripcion_suministro') is-invalid @enderror" required>{{ old('descripcion_suministro') }}</textarea>
    ...
    @enderror
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="cantidad_suministro" id="cantidad_suministro" class="form-control @error('cantidad_suministro') is-invalid @enderror" value="{{ old('cantidad_suministro') }}" required min="1">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="costo_unitario" id="costo_unitario" class="form-control @error('costo_unitario') is-invalid @enderror" value="{{ old('costo_unitario') }}" required step="0.01" min="0">
