    ...
    <div class="card-body">
        <form action="{{ route('suministros.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre_suministro" id="nombre_suministro" class="form-control @error('nombre_suministro') is-invalid @enderror" value="{{ old('nombre_suministro') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea name="descripcion_suministro" id="descripcion_suministro" class="form-control @error('descripcion_suministro') is-invalid @enderror">{{ old('descripcion_suministro') }}</textarea>
